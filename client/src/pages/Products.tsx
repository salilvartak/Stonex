    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="bg-primary text-white py-20 border-b-4 border-accent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-5xl md:text-6xl font-display font-bold mb-4">OUR PRODUCTS</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {products?.map((product, idx) => (
              <AnimatedSection key={product.id} delay={idx * 0.1}>
                <Link href={`/products/${product.slug}`} className="group block bg-white h-full shadow-sm hover:shadow-2xl transition-all duration-300">
